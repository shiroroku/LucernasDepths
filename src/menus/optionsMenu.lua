...
OptionsMenuScene = Scene:new()

---@param return_function function
---@return OptionsMenuScene
function OptionsMenuScene:new(return_function)
    local o = Scene:new()
...
function OptionsMenuScene:load()
    Scene.load(self)
...
function OptionsMenuScene:update(dt)
    self.scrollbox:update(dt)
end

function OptionsMenuScene:draw()
...
function OptionsMenuScene:keyPress(key, scancode, isrepeat)
