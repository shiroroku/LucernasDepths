...
local function ColorizeCharacterTexture(character_name, skin_hsl, clothes_hsl, primary_hsl, secondary_hsl)
    local skin      = love.image.newImageData(string.format("resources/textures/sprites/%s/skin.png", character_name))
    local clothes   = love.image.newImageData(string.format("resources/textures/sprites/%s/clothes.png", character_name))
    local primary   = love.image.newImageData(string.format("resources/textures/sprites/%s/primary.png", character_name))
    local secondary = love.image.newImageData(string.format("resources/textures/sprites/%s/secondary.png", character_name))
...
CHARACTERS = {
    chroma = function(skin_hsl, clothes_hsl, primary_hsl, secondary_hsl)
        local chroma_sheet_texture = ColorizeCharacterTexture("chroma", skin_hsl, clothes_hsl, primary_hsl, secondary_hsl)
